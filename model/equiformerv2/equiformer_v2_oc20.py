...
class EquiformerV2_OC20(BaseModel):
    """Define Class EquiformerV2_OC20."""
    ...
    def _init_edge_rot_mat(self, data, edge_index, edge_distance_vec):
        """Run _init_edge_rot_mat method."""
        # code.
        return init_edge_rot_mat(edge_distance_vec)

    @property
    def num_params(self):
        """Run num_params method."""
        # code.
        return sum(p.numel() for p in self.parameters())

    def _init_weights(self, m):
        """Run _init_weights method."""
        # code.
    ...
    def _uniform_init_rad_func_linear_weights(self, m):
        """Run _uniform_init_rad_func_linear_weights method."""
        # code.
        if (isinstance(m, RadialFunction)):
            m.apply(self._uniform_init_linear_weights)

    def _uniform_init_linear_weights(self, m):
        """Run _uniform_init_linear_weights method."""
        # code.
        if isinstance(m, torch.nn.Linear):
            if m.bias is not None:
                torch.nn.init.constant_(m.bias, 0)
