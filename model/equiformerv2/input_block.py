...
class EdgeDegreeEmbedding(torch.nn.Module):
    """Define Class EdgeDegreeEmbedding."""
    ...
    def forward(
        ...
        # print(f"size x_edge_m_0:{x_edge_m_0.size()}")
        # print(f"size x_edge_m_pad:{x_edge_m_0.size()}")
        x_edge_m_all = torch.cat((x_edge_m_0, x_edge_m_pad), dim=1) # may over cache
