...
class ScaledSmoothLeakyReLU(torch.nn.Module):
    """Define Class ScaledSmoothLeakyReLU."""
...
class SeparableS2Activation(torch.nn.Module):
    """Define Class SeparableS2Activation."""
