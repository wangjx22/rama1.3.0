...
yaml_path=${PROJECT_DIR}/yamls/scoring_train_yamls/train_debug_equiformerv2_dataset.yaml
device_ids=2
gpus=1
...
base_lr=0
max_lr=0.0001
output_dir=/nfs_beijing_ai/ziqiao-2/tmp/rama-scoring-v1.3.0-dev-outputs/debug-test/equiformerv2_dataset/
mkdir -p ${output_dir}
#launch_mode=$1
