...
class LRScheduler(torch.optim.lr_scheduler._LRScheduler):
    ...
    def __init__(
        ...
        start_decay_after_n_steps: int = 5000,
        decay_every_n_steps: int = 5000,
    ...
    def get_lr(self):
        ...
        return [max(lr,self.min_lr) for group in self.optimizer.param_groups]
